      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
            <form method="POST" class="form" action="{{ route('auth.post') }}">
              @csrf
              <div class="card card-login card-hidden">
                ...
                <div class="card-footer justify-content-center mt-3">
                  <button type="submit" class="btn btn-rose btn-md mr-3">Login</button>
                  <a href="{{ route('auth.register') }}" class="btn btn-rose btn-link btn-lg">Register</a>
                </div>
              </div>
            </form>
          </div>
